...
#define MinPW 500.0 //calibration value for 000 degrees
...
void servo_init()
{
    ...
    GPIO_PORTB_AFSEL_R |= 0x20;   //Uses alternate hardware
...
void servo_calibrate(void)
{
    ...
    while (1)
    {
        button = button_getButtonBlocking();
        if (count == 4)
        {
            count = 0;
        }
