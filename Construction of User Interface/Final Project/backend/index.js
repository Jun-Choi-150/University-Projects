...
app.get("/product/:id", async (req, res) => {
  ...
  try {
    ...
    console.log("Error while fetching product information:" + err);
    res.status(500).send({ message: "Error while fetching product information" });
  }
});
...
app.put("/update", async (req, res) => {
  ...
  try {
    ...
    const messageResponse = {
      message: `Product ${_id} updated with new price: ${newPrice}`,
      updatedProduct,
    };
