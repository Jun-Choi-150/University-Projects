...
/**
 * @author sabrinaf
 * the StringRequestActivity class is the class for the
 * login page and makes a JSON array request to search through
 * the database to check if the user logging in is valid
 */
public class StringRequestActivity extends Activity implements OnClickListener {
    ...
    /**
     * connects this class to the activity_string_request page layout along with
     * its elements
...
//        btnJsonArray.setOnClickListener(this);
    ...
    /**
     * Making JSON array request to get all users login info
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            for(int i = 0; i < jsonArray.length(); i++) {
                                if (email.getText().toString().equals(jsonArray.getJSONObject(i).getString("username")) && password.getText().toString().equals(jsonArray.getJSONObject(i).getString("password"))) {
                                    startActivity(new Intent(StringRequestActivity.this, LoginActivity.class));
                                    correctUser = true;
...
//        ImageLoader imageLoader = AppController.getInstance().getImageLoader();
        String url = Const.URL_JSON_USER + "/search?username=" + name;
        //showProgressDialog();
    ...
    /**
     * handles all clicks of the corresponding page
